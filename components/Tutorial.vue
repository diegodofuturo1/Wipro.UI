...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      // Service.customer.list().then(response => console.log('customers: ' + response))
      // Service.dvd.list().then(response => console.log('dvds: ' + response))
      // Service.locator.list().then(response => console.log('locators: ' + response))
      // Service.movie.list().then(response => console.log('movies: ' + response))
      // Service.rent.list().then(response => {
      //   this.rents = response.data
      //   console.log('response: ' + response)
      // })
    
      // Service.customer.get('1').then(response => console.log('customers: ' + response))
      // Service.dvd.get('1').then(response => console.log('dvds: ' + response))
      // Service.locator.get('1').then(response => console.log('locators: ' + response))
      // Service.movie.get('1').then(response => console.log('movies: ' + response))
      // Service.rent.get('1').then(response => console.log('rents: ' + response))
      
      // Service.customer.post({ name: 'Douglas', email: 'douglas@email.com', phone: '+55(11)92837-0938', cpf: '384.034.349-17' }).then(response => console.log('customers: ' + response))
      // Service.dvd.post({ price: '30.00', movieId: '1' }).then(response => console.log('dvds: ' + response))
      // Service.locator.post({ name: 'Douglas', email: 'douglas@email.com', phone: '+55(11)92837-0938', cpf: '384.034.349-17' }).then(response => console.log('locators: ' + response))
      // Service.movie.post({ name: 'Harry Potter e o Prisioneiro de Askhaban', gender: 'Aventura Fantasiosa', releaseDate: '04/06/2014', duration: '2h22', image: 'https://br.web.img2.acsta.net/medias/nmedia/18/93/88/04/20282944.jpg' }).then(response => console.log('movies: ' + response))
      // Service.rent.post({ dvdId: '1', customerId: '1', locatorId: '1', rentDate: '01/10/2021' }).then(response => console.log('rents: ' + response))
    }
  }
</script>
